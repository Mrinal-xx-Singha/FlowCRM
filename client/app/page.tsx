...
export default function Home() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 selection:bg-blue-100">
      {/* Navigation */}
      <nav className="container mx-auto px-6 py-4 flex items-center justify-between border-b border-slate-200/60 bg-white/50 backdrop-blur-md sticky top-0 z-50">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 bg-blue-600 rounded-lg flex items-center justify-center">
            <span className="text-white font-bold text-xl leading-none">F</span>
          </div>
          <span className="text-xl font-bold tracking-tight text-slate-900">FlowCRM</span>
        </div>
        <div className="flex items-center gap-4">
          ...
          <Link href="/signup">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white shadow-sm transition-all rounded-full px-6">
              Get Started Free
            </Button>
          </Link>
        </div>
      ...
      <main className="container mx-auto px-6 pt-24 pb-32 text-center max-w-4xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/signup">
            <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white w-full sm:w-auto rounded-full px-8 h-14 text-base shadow-lg shadow-blue-200 transition-transform hover:-translate-y-0.5">
              Start for Free <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </Link>
          <Link href="/login">
            <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-full px-8 h-14 text-base border-slate-200 hover:bg-slate-100 text-slate-700">
              Go to Dashboard
            </Button>
          </Link>
        </div>
      ...
      <section className="bg-white border-t border-slate-200 py-24">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-slate-900 mb-4">Everything you need to close the deal</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">We stripped away the confusing corporate bloat to give you a CRM that feels lightweight, fast, and incredibly intuitive.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-2xl p-8 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Visual Pipeline</h3>
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-2xl p-8 hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-slate-900 mb-3">Customer Hub</h3>
              <p className="text-slate-600 leading-relaxed">
        ...
        <div className="container mx-auto px-6 text-center flex flex-col items-center">
          <div className="flex items-center gap-2 mb-6 opacity-80">
            <div className="h-6 w-6 bg-slate-700 rounded flex items-center justify-center">
              <span className="text-slate-300 font-bold text-xs leading-none">F</span>
            </div>
